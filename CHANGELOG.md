...
see: https://coreui.io/react/docs/

BREAKING CHANGES:
- drop reactstrap in favour of [@coreui/react](https://github.com/coreui/coreui-react) component library
- new [CoreUI v3](https://coreui.io/react/) template layout look and feel
- `dark-theme` toggler 
- new `CDataTable` component
- new `_nav.js` shape  
